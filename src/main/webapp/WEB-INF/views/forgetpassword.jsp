          ...
          <div class="card-body p-4 p-md-5">
            ...
            <form  action="forgetpassword" method="post">
					...
					<div class="input-group form-group">
						...
						<input type="newpassword" class="form-control" placeholder="newpassword" name="newpassword">
					</div>
					...
					<div class="input-group form-group">
						...
						<input type="confpassword" class="form-control" placeholder="confpassword" name="confpassword">
					</div>              
